...
public class User {
    @Id
    @GeneratedValue //si se pone es autoincrementables, justo con todos los autosincrementables
    private Long id;
    private String username;
    private String password;
    private Boolean enabled;

    //creamos relación. Un usuario para springSecurity un usuario tiene muchos. Y tiene esa lógica internamente
    //tenemos que crear la relación de usuario a su rol
    ...
    //funcion que trae por defecto java, pero lo vamos a sobreescribir
    //Esto nos permite imprimir algunos resultados de manera efectiva
    //permite verificar que el desencriptado y el login fue exitoso
    @Override
    public int hashCode(){
        final int prime = 31; //más segura la contraseña
        int result = 1;
